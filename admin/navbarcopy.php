<nav class="navbar navbar-expand-lg bg-body-tertiary border border-dark rounded p-4">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="image/logo.jfif" style = "width: 80px; height: 80px;" class="img-responsive"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search" method="get" action="viewProduct.php">
        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="tsearch"/>
