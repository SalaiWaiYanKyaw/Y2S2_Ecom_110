...
if (isset($_GET['eid'])) {
    ...
    { $productName = $_POST['pname'];
     ...
     // echo $fileImg['name'], "<br>";
     // echo $fileImg['type'], "<br>";
      //echo $fileImg['size'], "<br>";
      //echo $fileImg['tmp_name'], "<br>";
      ...
      $filePath = "productImage/$fileImg[name]";
       ...
       if ($status) 
       {
        try
        {$pid = $_POST['pid'];
            $sql = "update products set productName=?, category=?, price=?, qty=?, description=?, imgPath=? where productID=?";
            $stmt = $conn->prepare($sql);
